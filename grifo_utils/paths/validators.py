...
class FileValidator(object):
    error_messages = {
        'max_size': (_("Files must be under %(max_size)s."
                       "File size %(size)s.")),
        'min_size': (_("Files must be over %(min_size)s. "
                       "File size %(size)s.")),
        'content_type': _("File not supported."),
        'content_type2': _("File type %(content_type)s not supported."),
    }
